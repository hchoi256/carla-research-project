        ...
        for event in pygame.event.get():
            if event.type == pygame.QUIT:
                ...
                if self._is_quit_shortcut(event.key):
                    ...
                    # 1. Image Generation (DETR)
                    # check if '_out' exists, otherwise skip                                        
                    img_path = "../examples/_out"                    
                    if os.path.isdir(img_path): # '_out' exists                        
                        files=os.listdir(img_path)                        
                        # option 1: random selection
                        image = random.choice(files)
                        # TODO: option 2: latest selection (possible improvement)
                    else:
                        pass                    
                    ...
                    # Print the realtime information of the agents
                    ...
                    while True:
                        ...
                        for i in range(len(vehicles)):
                            ...
                            actor_i_status = 'Vehicle_ID:{%s}, Location_X:{%.3f}, Location_Y:{%.3f}.\n' %(i, loc.x, loc.y)                                                                                    
                            INFO += actor_i_status
                        
                        # Set the print inteval
                        if round(abs(timestamp - cur_t), 1) == .1:
                            print('-------------------------------------------------------------------------------')                            
                            print(INFO)
                            print('-------------------------------------------------------------------------------\n')
                            cur_t = timestamp
